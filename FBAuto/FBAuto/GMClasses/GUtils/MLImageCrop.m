...
- (void)viewDidLoad
{
    ...
    self.overlayView.layer.borderColor = [[UIColor blackColor]CGColor];//截取框的颜色
...
//    buttonBackgroundView.layer.opacity = 0.25f;
    ...
    [self.view addSubview:self.confirmButton = [self acquireCustomButtonWithTitle:@"选取" andAction:@selector(onConfirm:)]];
...
- (UIView*)acquireBlackTransparentOverlayView//截取层颜色
{
...
#define kButtonWidth 50
    ...
    self.confirmButton.frame = CGRectMake(CGRectGetWidth(self.buttonBackgroundView.frame)-kButtonWidth-5, CGRectGetMinY(self.buttonBackgroundView.frame), kButtonWidth, kButtonViewHeight);

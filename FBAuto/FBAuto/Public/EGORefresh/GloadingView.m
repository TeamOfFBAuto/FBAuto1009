...
@interface GloadingView()
@property (nonatomic, strong) UIView *maskView;
@end

@implementation GloadingView
...
- (UILabel*)normalLabel
{
    if (!_normalLabel) {
        ...
        _normalLabel.text = NSLocalizedString(@"查看更早的消息...", nil);
...
- (void)stopLoading:(int)loadingType
{
    ...
    switch (loadingType) {
        case 1:
            ...
            [self.normalLabel setText:NSLocalizedString(@"查看更早的消息...", nil)];
